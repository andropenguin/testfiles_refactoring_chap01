 ...
 * in p.32 of Refactoring Japanese Edition. It is a test for
 * statment method supporting ascii and html formats.
 */
...
public class CustomerTest {
	...
	@Test
	public void html_statement_regular_days_rented_is_1() {
		Movie movie = new Movie("movie1", Movie.REGULAR);
		int daysRented = 1;
		Rental rental1 = new Rental(movie, daysRented);
		foo.addRental(rental1);
		String result = foo.htmlStatement();
		String expected_result = "<H1>Rentals for <EM>foo</EM></H1><P>\n" +
				"movie1" + ": " + "2.0" + "<BR>\n" +
	...
	@Test
	public void html_statement_regular_days_rented_is_3() {
		Movie movie = new Movie("movie1", Movie.REGULAR);
		int daysRented = 3;
		Rental rental1 = new Rental(movie, daysRented);
		foo.addRental(rental1);
	...
	@Test
	public void html_statement_new_release_days_rented_is_1() {
		Movie movie = new Movie("movie1", Movie.NEW_RELEASE);
		int daysRented = 1;
		Rental rental1 = new Rental(movie, daysRented);
		foo.addRental(rental1);
	...
	@Test
	public void html_statement_new_release_days_rented_is_2() {
		Movie movie = new Movie("movie1", Movie.NEW_RELEASE);
		int daysRented = 2;
		Rental rental1 = new Rental(movie, daysRented);
		foo.addRental(rental1);
	...
	@Test
	public void html_statement_childrens_days_rented_is_2() {
		Movie movie = new Movie("movie1", Movie.CHILDRENS);
		int daysRented = 1;
		Rental rental1 = new Rental(movie, daysRented);
		foo.addRental(rental1);
	...
	@Test
	public void html_statement_childrens_days_rented_is_4() {
		Movie movie = new Movie("movie1", Movie.CHILDRENS);
		int daysRented = 4;
		Rental rental1 = new Rental(movie, daysRented);
		foo.addRental(rental1);
	...
	@Test
	public void html_statement_regular_days_rented_is_1_and_regular_days_rented_is_3() {
		Movie movie1 = new Movie("movie1", Movie.REGULAR);
		int daysRented1 = 1;
		Rental rental1 = new Rental(movie1, daysRented1);
		foo.addRental(rental1);
	...
	@Test
	public void html_statement_regular_days_rented_is_1_and_new_release_days_rented_is_1() {
		Movie movie1 = new Movie("movie1", Movie.REGULAR);
		int daysRented1 = 1;
		Rental rental1 = new Rental(movie1, daysRented1);
		foo.addRental(rental1);
	...
	@Test
	public void html_statement_regular_days_rented_is_1_and_childrens_days_rented_is_2() {
		Movie movie1 = new Movie("movie1", Movie.REGULAR);
		int daysRented1 = 1;
		Rental rental1 = new Rental(movie1, daysRented1);
		foo.addRental(rental1);
	...
	@Test
	public void html_statement_new_release_days_rented_is_1_and_new_release_days_rented_is_2() {
		Movie movie1 = new Movie("movie1", Movie.NEW_RELEASE);
		int daysRented1 = 1;
		Rental rental1 = new Rental(movie1, daysRented1);
		foo.addRental(rental1);
	...
	@Test
	public void html_statement_new_release_days_rented_is_1_and_childrens_days_rented_is_2() {
		Movie movie1 = new Movie("movie1", Movie.NEW_RELEASE);
		int daysRented1 = 1;
		Rental rental1 = new Rental(movie1, daysRented1);
		foo.addRental(rental1);
	...
	@Test
	public void html_statement_childrens_days_rented_is_2_and_childrens_days_rented_is_4() {
		Movie movie1 = new Movie("movie1", Movie.CHILDRENS);
		int daysRented1 = 2;
		Rental rental1 = new Rental(movie1, daysRented1);
		foo.addRental(rental1);
